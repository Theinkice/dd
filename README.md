...
```
```
wget -N --no-check-certificate https://raw.githubusercontent.com/theinkice/dd/main/InstallNET.sh && chmod +x InstallNET.sh && ./InstallNET.sh -d 11 -v 64 -p "theinkice" -port "22"
```
## 关于debian8源报错
...
## 快速使用示例:
``` 	
bash <(wget --no-check-certificate -qO- 'https://raw.githubusercontent.com/theinkice/dd/main/InstallNET.sh') -d 8 -v 64 -a
```

## 下载及说明:
``` 
wget --no-check-certificate -qO InstallNET.sh 'https://raw.githubusercontent.com/theinkice/dd/main/InstallNET.sh' && chmod +x InstallNET.sh
```
```
Usage:
...
```
wget -N --no-check-certificate https://raw.githubusercontent.com/theinkice/dd/main/gdlink.sh && chmod +x gdlink.sh && ./gdlink.sh
```
2.使用方法
```
